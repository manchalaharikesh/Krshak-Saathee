...
df = pd.read_csv('..\datasets\district_data.csv')
district_X=df[['Year']]
district_y=df[['GROUNDNUT PRODUCTION (1000 Quintal)']]
...
#pickle file
pickle.dump(district, open('..\pkl_files\\groundnut_district_model.pkl', 'wb'))